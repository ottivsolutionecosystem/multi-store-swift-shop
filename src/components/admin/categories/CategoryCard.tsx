...
export function CategoryCard({ category, subcategories = [], onEdit, onDelete, parentCategory }: CategoryCardProps) {
  return (
          ...
          <div className="flex-1 min-w-0">
            ...
            {subcategories.length > 0 && (
              <div className="flex flex-wrap gap-1">
                <span className="text-xs text-gray-500 mr-2">Subcategorias:</span>
